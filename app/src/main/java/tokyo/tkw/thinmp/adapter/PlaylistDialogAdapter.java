...
public class PlaylistDialogAdapter extends RecyclerView.Adapter<PlaylistViewHolder> {
    private List<Playlist> playlists;
    private PlaylistClickListener playlistClickListener;

    public PlaylistDialogAdapter(List<Playlist> playlists, PlaylistClickListener playlistClickListener) {
