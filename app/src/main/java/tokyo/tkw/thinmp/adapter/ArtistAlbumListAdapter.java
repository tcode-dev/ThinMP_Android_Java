...
public class ArtistAlbumListAdapter extends ArrayAdapter<Album> {
    ...
    public ArtistAlbumListAdapter(@NonNull Activity context, int resource, @NonNull ArrayList<Album> albumList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Bitmap thumbnail = mThumbnailController.getThumbnail(album.getThumbnailId());
